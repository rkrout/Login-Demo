...
<form method="post" class="border border-gray-300 rounded-md p-6 max-w-xl mx-auto my-8">
    ...
    <div class="mb-6">
        ...
        <input type="text" name="email" id="email" class="border border-gray-300 rounded px-4 py-2 w-full focus:ring-orange-600
    ...
    focus:ring-1 focus:ring-orange-600 focus:ring-offset-1">Login</button>
</form>
