        ...
        <tbody class="text-center">
            <?php foreach($users as $user): ?>
                <tr class="border-t border-t-gray-300">
                    ...
                    <td class="p-2"><?= "Every " . $user["break_interval"] . "hr" ?></td>
                    <td class="p-2"><?= $user["break_time"] . "min" ?></td>
                    <td class="p-2"><?= intdiv($user["total_break_time"], 60) . "hr " . $user["total_break_time"] % 60 . "min" ?></td>
