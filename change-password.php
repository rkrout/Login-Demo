...
<form method="post" class="border border-gray-300 rounded-md p-6 max-w-xl mx-auto my-8">
    ...
    <div class="mb-6">
        ...
        <input type="password" name="oldPassword" id="oldPassword" class="border border-gray-300 rounded px-4 py-2 w-full focus:ring-orange-600
        focus:ring-1 focus:border-orange-600 outline-none">
    </div>

    <div class="mb-6">
        <label for="newPassword" class="mb-1 block">New Password</label>
        <input type="password" name="newPassword" id="newPassword" class="border border-gray-300 rounded px-4 py-2 w-full focus:ring-orange-600
        focus:ring-1 focus:border-orange-600 outline-none">
    </div>

    <div class="mb-6">
        <label for="confirmNewPassword" class="mb-1 block">Confirm New Password</label>
        <input type="password" name="confirmNewPassword" id="confirmNewPassword" class="border border-gray-300 rounded px-4 py-2 w-full focus:ring-orange-600
        focus:ring-1 focus:border-orange-600 outline-none">
    </div>
    ...
    <div class="flex gap-1">
        ...
        focus:ring-1 focus:ring-orange-600 focus:ring-offset-1">Change Password</button>
    </div>
</form>
