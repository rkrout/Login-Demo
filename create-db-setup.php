...
if(isset($_POST["host"])) {
    ...
    echo "<script>alert('Database setup successfull'); window.location.href='/config.php'</script>";
    die();
}
...
<form method="post" class="border border-gray-300 rounded-md p-6 max-w-xl mx-auto my-8">
    ...
    focus:ring-1 focus:ring-orange-600 focus:ring-offset-1">Set Up</button>
</form>
